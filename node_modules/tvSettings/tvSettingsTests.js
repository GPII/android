...
var fluid = require("universal"),
    ...
    androidSettings = bridge.load("com.tpvision.gpiitvproxy.TvSettingsImpl",
                                      thatall);

jqUnit.module("GPII TV Settings");

jqUnit.test("Running tests for tvSettings node module", function () {
    jqUnit.expect(11);
    ...
    require("tvSettings");
    var asSettingsHandler = fluid.registerNamespace("gpii.tvSettings");
