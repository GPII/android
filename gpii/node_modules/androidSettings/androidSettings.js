...
(function () {
    ...
    fluid.registerNamespace("gpii.androidSettings");

    fluid.defaults("gpii.androidSettings.get", {
    ...
    fluid.defaults("gpii.androidSettings.set", {
        gradeNames: "fluid.function",
        argumentMap: {
            settingsarray: 0
        }
    ...
    gpii.androidSettings.get = function(settingsarray) {
    ...
    gpii.androidSettings.set = function(settingsarray) {
        var androidSettings = bridge.load("net.gpii.AndroidSettingsImpl", thatall);
        var app = fluid.copy(settingsarray);
            ...
            for (var j = 0; j < app[appId].length; j++) {
                ...
                for (var settingKey in settings) {
                    ...
                    if (typeof(value) === "number") {
                        value = parseInt(Math.abs(value), 10).toString();
